...
const Desktop = () => {
  ...
  const taskbarPosition =
    theme.behavior.startMenuMount === 'top' ? 'top' : 'bottom'

  return (
    <div
      className='cm-layer-root'
      style={{
        width: '100vw',
        height: '100vh',
    ...
    >
      <div className='cm-layer cm-layer--base'>
        <MountProvider name='layer-base' className='cm-layer__content'>
          <div
            style={{
              width: '100%',
              height: '100%',
          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      <Popover
                        content={
                          <Text>Popover should stay above windows.</Text>
                        }
            ...
            <MountProvider
              name='layout-bottom'
              style={{ gridRow: 3, gridColumn: '1 / 4' }}
            />
          </div>
        </MountProvider>
      </div>
      <div className='cm-layer cm-layer--always-top'>
        <MountProvider name='layer-always-top' className='cm-layer__content' />
      </div>
      <div className='cm-layer cm-layer--anchors'>
        <MountProvider name='layer-anchors' className='cm-layer__content' />
      ...
      <div className='cm-layer cm-layer--popups'>
        <MountProvider name='layer-popups' className='cm-layer__content' />
      </div>
