...
Define explicit `CWindowTitle` composition and drag-handle behavior for moving the owning `CWindow`, including a concrete Win98 title implementation contract.
