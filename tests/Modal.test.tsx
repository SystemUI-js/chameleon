...
describe('Modal inherits Window behavior', () => {
  it('passes move/resize props to Window', () => {
    ...
    const titleBar = document.body.querySelector('.cm-window__title-bar') as HTMLElement;
    const handle = document.body.querySelector('[data-direction="se"]') as HTMLElement;
